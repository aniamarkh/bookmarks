...
<template>
  <div class="top-panel">
    ...
    <Transition>
      <HiddenCatForm
        @close-form="closeHiddenForm"
        v-if="showHiddenCategories"
      />
    </Transition>
    <div
      class="top-panel--settings"
